...
use App\Contracts\IApiResponse;
use App\Traits\{ApiHelpers, ConvertsExceptionToApiResponse, RendersApiResponse, Translatable};
use Closure;
...
class ApiResponse implements IApiResponse
{
     ...
     * @return JsonResponse
     */
    public static function Success(mixed $Data, bool $Success = Status::HTTP_OK): JsonResponse
    {
        return self::CreateJsonResponse($Data, $Success);
    }
    ...
    public static function Error($Message, int $Status = Status::HTTP_OK, bool $Success = FALSE, array $Headers = [], bool $isArray = false): JsonResponse
    {
        ...
        return self::CreateJsonResponse($Message, $Status, $Success, $Headers);
    }
}
